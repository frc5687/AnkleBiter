...
public class SwerveSetpointGenerator {
  ...
  public SwerveSetpoint generateSetpoint(
    ...
    for (int m = 0; m < config.numModules; m++) {
      ...
      // System.out.println("prevSetpoint.moduleStates()[m] = "+prevSetpoint.moduleStates()[m]);

      // System.out.println("lastVelRadPerSec = "+lastVelRadPerSec);
      ...
      // System.out.println("moduleTorque = "+moduleTorque);
      moduleTorque = Math.min(moduleTorque, config.maxTorqueFriction);
      // System.out.println("maxTorqueFriction = "+config.maxTorqueFriction);


      double forceAtCarpet = moduleTorque / config.moduleConfig.wheelRadiusMeters;
      // System.out.println("forceAtCarpet = "+forceAtCarpet);
      // System.out.println("forceSign = "+forceSign);
      ...
      // System.out.println("moduleForceVec = "+moduleForceVec);
